...
class SimpleJointSpacePlanner:
    ...
    def __init__(self, urdf_string, ee_link, duration):
        ...
        self.robot = optas.RobotModel(urdf_string=urdf_string, time_derivs=[0, 1])
        ...
        pF = self.robot.get_global_link_position(ee_link, qF)
        oF = self.robot.get_global_link_quaternion(ee_link, qF)
        ...
        for t in range(T):
            ...
            p = self.robot.get_global_link_position(ee_link, q)
            z = p[2]
            zsafe = z + zpad
